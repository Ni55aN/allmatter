import builder from './node-builders';
import MaterialPreview from './material-preview';
import TexturePreview from './texture-preview';
import workers from './node-workers';
...
export default function ($scope, $el, a, env) {
    ...
    alight.directives.al.newProject = function (scope, el, expression, env) {
        el.onclick = () => {
            editor.fromJSON({id: 'proc-material@0.1.0', nodes: {}, groups: {}});
        }
    }
    ...
    editor = new D3NE.NodeEditor('proc-material@0.1.0', $el.querySelector('#nodeEditor'), 'https://d3-node-editor.surge.sh/view.html', builder, menu);
    editor
        .view
        .zoom
        .translateExtent([
    ...
    editor
        ...
        .on('change', async function (i) {
            ...
            var startId = Object
                .keys(data.nodes)
                .filter(key => data.nodes[key].title == 'Output material')[0];
    ...
    engine = new D3NE.Engine('proc-material@0.1.0', workers($scope, editor, materialPreview, texturePreview));
